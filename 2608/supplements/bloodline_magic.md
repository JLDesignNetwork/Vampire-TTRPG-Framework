...
# Bloodline Magic Compendium v2608.61.0-bs
...
### <a id="sanguine-scrying-mirror"></a>Sanguine Scrying Mirror `(Tier 1 Neonate Arcana — Hemomancy)`
* **Cost & Duration:** `1 Reserve | Duration: 10 Minutes Scrying`
* **Pillar 1 (Power Amplification):** Amplifies sensory powers ([*Thermal Vision*](../vampire.md#thermal-vision), [*Crimson Scent*](../vampire.md#crimson-scent)). By pouring blood into a silver bowl or obsidian pool, the caster projects their physical/vitae senses into a remote scrying feed.
* **Pillar 2 (Dual-Layer Benefits & Synergy):**
  ...
  * **Power Synergy Bonus:** Casters who natively possess sensory powers ([*Thermal Vision*](../vampire.md#thermal-vision), [*Crimson Scent*](../vampire.md#crimson-scent), or [*EM Gaze*](../vampire.md#em-gaze)) receive a **+2 Power Synergy Bonus** to all Bloodline Duel checks during scrying probes.
...
* **Pillar 1 (Power Amplification):** Amplifies protection and repulsion powers ([*Bane-Blindness*](../vampire.md#bane-blindness), [*Anointed Flesh*](../vampire.md#anointed-flesh)), projecting bloodline defensive tethers onto physical architectural entryways.
* **Pillar 2 (Dual-Layer Benefits & Synergy):**
  ...
  * **Power Synergy Bonus:** Casters who natively possess protection or defensive powers ([*Anointed Flesh*](../vampire.md#anointed-flesh) or [*Alchemical Assimilation*](../vampire.md#alchemical-assimilation)) receive a **+2 Power Synergy Bonus** to the ward's blood burn damage (inflicting **3 Fire/Thermal Damage** total).
...
### <a id="vitae-purification-filter"></a>Vitae Purification Filter `(Tier 1 Neonate Arcana — Hemomancy)`
...
*(Note: Silver is omitted as it poses no supernatural toxicity to vampires; see [Silver (Mythic Misconception)](../vampire.md#silver-mythic-misconception).)*

---

## Tier 2 Blood Sorcery (Elder Arcana)

### <a id="rhythm-of-the-ancestral-lineage"></a>Rhythm of the Ancestral Lineage `(Tier 2 Elder Arcana — Hemomancy)`
* **Cost & Duration:** `2 Reserves | Duration: 1 Scene (Communion)`
* **Power Amplification:** Amplifies [*Ancestral Memory*](../vampire.md#ancestral-memory). By burning blood in an ancient censer or bio-centrifuge, the caster breaks the core *Historical Scope Lock* of *Ancestral Memory*, opening a **live real-time telepathic communion feed** across the blood tether between Sire and progeny.
* **Standalone Benefit (All Casters):** Burning the blood censer grants a **+2 bonus to Cognition, Perception, and Historical Lore checks** for 1 Scene to the caster and all allied bloodline members in the room (whether they possess [*Ancestral Memory*](../vampire.md#ancestral-memory) or not).
* **Power Synergy Bonus:** Casters who natively possess [*Ancestral Memory*](../vampire.md#ancestral-memory) receive a **+2 Power Synergy Bonus** to all Bloodline Duel checks during live communion.
...
* **Torpor/Deceased Cap:** Probing a Sire or progeny in Torpor or True Death hard-caps back to baseline past memories only, adhering strictly to [*Ancestral Memory*](../vampire.md#ancestral-memory) scope.

### <a id="hematic-curse-of-inertia"></a>Hematic Curse of Inertia `(Tier 2 Elder Arcana — Hemomancy)`
* **Cost & Duration:** `2 Reserves | Duration: 1 Scene`
* **Pillar 1 (Power Amplification):** Amplifies thermal and decay powers ([*Grave Rot*](../vampire.md#grave-rot)), projecting cryogenic blood thickening magic into an enemy's circulatory system.
* **Pillar 2 (Dual-Layer Benefits & Synergy):**
  ...
  * **Power Synergy Bonus:** Casters who natively possess decay/necrotic powers ([*Grave Rot*](../vampire.md#grave-rot)) receive a **+2 Power Synergy Bonus** to the curse's Fortitude resistance DC.
...
### <a id="sanguine-transfusion-lock"></a>Sanguine Transfusion Lock `(Tier 2 Elder Arcana — Hemomancy)`
* **Cost & Duration:** `2 Reserves | Duration: 1 Combat Round (Action Lock)`
* **Pillar 1 (Power Amplification):** Amplifies blood-arresting and gravimetric powers ([*Grav-Crush*](../vampire.md#grav-crush)), manipulating exposed external blood flow to freeze an enemy's motor nervous system.
* **Pillar 2 (Dual-Layer Benefits & Synergy):**
  ...
  * **Power Synergy Bonus:** Casters who natively possess blood control powers ([*Gangrene Touch*](../vampire.md#gangrene-touch) or [*Grand Harmonization*](../vampire.md#grand-harmonization)) receive a **+2 Power Synergy Bonus** to the lock check / Fortitude resistance DC.
* **Pillar 3 (Defined Caps & Stunlock Immunity Cap):**
  * **Physical Lock Scope:** While locked, the target cannot perform physical movement, attacks, or gesture-based casting, but retains full consciousness and may speak or invoke purely mental/telepathic powers ([*Mind Tear*](../vampire.md#mind-tear)).
...
### <a id="astral-anchor-ritual"></a>Astral Anchor Ritual `(Tier 2 Elder Arcana — Astromancy)`
...
### <a id="grand-rite-of-hematic-transmutation"></a>Grand Rite of Hematic Transmutation `(Tier 3 Primordial Rites — Hemomancy)`
* **Cost & Duration:** `3 Reserves | Duration: 24 Hours (then reverts to water)`
* **Pillar 1 (Power Amplification):** Amplifies alchemical blood powers ([*Gangrene Touch*](../vampire.md#gangrene-touch), [*Grand Harmonization*](../vampire.md#grand-harmonization)), projecting biological transmutation magic across macro environmental water reservoirs.
* **Pillar 2 (Dual-Layer Benefits & Synergy):**
  ...
  * **Power Synergy Bonus:** Casters who natively possess alchemical blood powers ([*Gangrene Touch*](../vampire.md#gangrene-touch) or [*Grand Harmonization*](../vampire.md#grand-harmonization)) receive a **+2 Power Synergy Bonus** to the 1-hour ritual completion check and a **+2 bonus to Concentration tests** if disturbed during casting.
* **Pillar 3 (Defined Caps & Boundaries):**
  ...
  * **Regeneration Cap:** A vampire cannot regenerate more Blood Reserves from transmuted water in a single feeding session than their standard per-night Reserve pool cap (see [Blood Reserve Math](../vampire.md#blood-reserve-math)).
* **Thrall Susceptibility Protocol:** Mortals drinking the transmuted water gain **Susceptibility** (50% easier to enthrall via deliberate blood bond feeding). Drinking transmuted water does **NOT** automatically create a Thrall bond — an intentional feeding enthrallment is still required. Standard [Thrall Cap rules](../vampire.md#thrall-cap) and overage penalties apply.

### <a id="eclipse-of-the-sanguine-tide"></a>Eclipse of the Sanguine Tide `(Tier 3 Primordial Rites — Hemomancy)`
* **Cost & Duration:** `3 Reserves | Duration: 1 Entire Night`
* **Pillar 1 (Power Amplification):** Amplifies environmental and mist powers ([*Mist Form*](../vampire.md#mist-form), [*Nightmare Visage*](../vampire.md#nightmare-visage)), elevating local mist into a macro 1-mile blood fog envelope.
* **Pillar 2 (Dual-Layer Benefits & Synergy):**
  * **Standalone Benefit (All Casters):** The Ancient channels an explosive crimson beacon into the night sky, rolling a thick crimson fog across a **1-mile radius**. Completely blocks moonlight and star guidance. All allied vampires inside gain **+1 to Perception and Tracking checks**, **+1 damage/potency to blood powers**, and [Eclipse Overcap](../vampire.md#blood-reserve-math) (+2 Neonate, +3 Elder, +4 Ancient).
  * **Power Synergy Bonus:** Allied casters inside the fog zone who natively possess environmental or illusion powers ([*Mist Form*](../vampire.md#mist-form) or [*Nightmare Visage*](../vampire.md#nightmare-visage)) receive a **+2 Power Synergy Bonus** to power DCs and save DCs for powers cast inside the fog.
...
* **Eclipse Overcap Table:**
  ...
  A vampire may harvest multiple times during the Eclipse night, returning to tithe after each 5-reserve harvest threshold. Standard [Law of the Sanguine Tithe](../vampire.md#coven-structure--governance) obligations apply to all reserves *harvested* during the Eclipse window. **No Over-Tithe Credit:** Each tithe period is calculated and settled independently. Donating surplus reserves generates zero forward credit.

---

## Integration & Compatibility

This supplement is 100% compatible with **Vampire TTRPG Framework v2608.61.0-bs**. All ritual rules interact cleanly with [Coven Governance Law](../vampire.md#social), [Torpor Recovery Track](../vampire.md#torpor), and [Age Tier Superiority Mechanics](../vampire.md#age-tier-superiority-modifier-system).
