...
### Sanguine Scrying Mirror `(Tier 1 Neonate Arcana — Hemomancy)`
* **Cost & Duration:** `1 Reserve | Duration: 10 Minutes Scrying`
* **Pillar 1 (Power Amplification):** Amplifies sensory powers ([*Thermal Vision*](../vampire.md#cognimancy-perception-flir-optics--bio-sonar), [*Crimson Scent*](../vampire.md#cognimancy-perception-flir-optics--bio-sonar)). By pouring blood into a silver bowl or obsidian pool, the caster projects their physical/vitae senses into a remote scrying feed.
* **Pillar 2 (Dual-Layer Benefits & Synergy):**
  ...
  * **Power Synergy Bonus:** Casters who natively possess sensory powers ([*Thermal Vision*](../vampire.md#cognimancy-perception-flir-optics--bio-sonar), [*Crimson Scent*](../vampire.md#cognimancy-perception-flir-optics--bio-sonar), or [*EM Gaze*](../vampire.md#cognimancy-perception-flir-optics--bio-sonar)) receive a **+2 Power Synergy Bonus** to all Bloodline Duel checks during scrying probes.
...
### Ritual of the Crimson Ward `(Tier 1 Neonate Arcana — Hemomancy)`
* **Cost & Duration:** `1 Reserve | Duration: 24 Hours (1 Night)`
* **Pillar 1 (Power Amplification):** Amplifies protection and repulsion powers ([*Bane-Blindness*](../vampire.md#immunomancy-bane-protection-wards--solar-shielding), [*Anointed Flesh*](../vampire.md#immunomancy-bane-protection-wards--solar-shielding)), projecting bloodline defensive tethers onto physical architectural entryways.
* **Pillar 2 (Dual-Layer Benefits & Synergy):**
  ...
  * **Power Synergy Bonus:** Casters who natively possess protection or defensive powers ([*Anointed Flesh*](../vampire.md#immunomancy-bane-protection-wards--solar-shielding) or [*Alchemical Assimilation*](../vampire.md#immunomancy-bane-protection-wards--solar-shielding)) receive a **+2 Power Synergy Bonus** to the ward's blood burn damage (inflicting **3 Fire/Thermal Damage** total).
...
### Vitae Purification Filter `(Tier 1 Neonate Arcana — Hemomancy)`
* **Cost & Duration:** `1 Reserve (Pre-Ingestion) / 2 Reserves (Emergency Post-Ingestion Purge) | Duration: Instantaneous`
* **Pillar 1 (Power Amplification):** Amplifies internal blood control powers ([*Gangrene Touch*](../vampire.md#biomancy-healing-biological-grafting--vital-control), [*Grand Harmonization*](../vampire.md#biomancy-healing-biological-grafting--vital-control)), projecting biological blood purity magic onto external or ingested blood.
* **Pillar 2 (Dual-Layer Benefits & Synergy):**
  ...
  * **Power Synergy Bonus:** Casters who natively possess blood control powers ([*Gangrene Touch*](../vampire.md#biomancy-healing-biological-grafting--vital-control) or [*Grand Harmonization*](../vampire.md#biomancy-healing-biological-grafting--vital-control)) receive a **+2 Power Synergy Bonus** to all [Fortitude/Constitution checks](../vampire.md#creation) against lingering systemic toxins or contagions.
...
### Rhythm of the Ancestral Lineage `(Tier 2 Elder Arcana — Hemomancy)`
* **Cost & Duration:** `2 Reserves | Duration: 1 Scene (Communion)`
* **Power Amplification:** Amplifies [*Ancestral Memory*](../vampire.md#psychomancy-mind-illusion-telekinesis--influence). By burning blood in an ancient censer or bio-centrifuge, the caster breaks the core *Historical Scope Lock* of *Ancestral Memory*, opening a **live real-time telepathic communion feed** across the blood tether between Sire and progeny.
* **Standalone Benefit (All Casters):** Burning the blood censer grants a **+2 bonus to Cognition, Perception, and Historical Lore checks** for 1 Scene to the caster and all allied bloodline members in the room (whether they possess *Ancestral Memory* or not).
* **Power Synergy Bonus:** Casters who natively possess [*Ancestral Memory*](../vampire.md#psychomancy-mind-illusion-telekinesis--influence) receive a **+2 Power Synergy Bonus** to all Bloodline Duel checks during live communion.
...
* **Torpor/Deceased Cap:** Probing a Sire or progeny in Torpor or True Death hard-caps back to baseline past memories only, adhering strictly to [*Ancestral Memory*](../vampire.md#psychomancy-mind-illusion-telekinesis--influence) scope.

### Hematic Curse of Inertia `(Tier 2 Elder Arcana — Hemomancy)`
* **Cost & Duration:** `2 Reserves | Duration: 1 Scene`
* **Pillar 1 (Power Amplification):** Amplifies thermal and decay powers ([*Grave Rot*](../vampire.md#necromancy-death-soul--undead-manipulation)), projecting cryogenic blood thickening magic into an enemy's circulatory system.
* **Pillar 2 (Dual-Layer Benefits & Synergy):**
  ...
  * **Power Synergy Bonus:** Casters who natively possess decay/necrotic powers ([*Grave Rot*](../vampire.md#necromancy-death-soul--undead-manipulation)) receive a **+2 Power Synergy Bonus** to the curse's Fortitude resistance DC.
...
### Sanguine Transfusion Lock `(Tier 2 Elder Arcana — Hemomancy)`
* **Cost & Duration:** `2 Reserves | Duration: 1 Combat Round (Action Lock)`
* **Pillar 1 (Power Amplification):** Amplifies blood-arresting and gravimetric powers ([*Instant Cardiac Lock*](../vampire.md#torpor), [*Grav-Crush*](../vampire.md#gravimancy-gravity-control-mass-defiance--force-fields)), manipulating exposed external blood flow to freeze an enemy's motor nervous system.
* **Pillar 2 (Dual-Layer Benefits & Synergy):**
  ...
  * **Power Synergy Bonus:** Casters who natively possess blood control powers ([*Instant Cardiac Lock*](../vampire.md#torpor) or [*Gangrene Touch*](../vampire.md#biomancy-healing-biological-grafting--vital-control)) receive a **+2 Power Synergy Bonus** to the lock check / Fortitude resistance DC.
* **Pillar 3 (Defined Caps & Stunlock Immunity Cap):**
  * **Physical Lock Scope:** While locked, the target cannot perform physical movement, attacks, or gesture-based casting, but retains full consciousness and may speak or invoke purely mental/telepathic powers ([*Mind Tear*](../vampire.md#psychomancy-mind-illusion-telekinesis--influence)).
...
### Astral Anchor Ritual `(Tier 2 Elder Arcana — Astromancy)`
* **Cost & Duration:** `2 Reserves | Duration: 24 Hours (Spatial Beacon)`
* **Pillar 1 (Power Amplification):** Amplifies spatial folding powers ([*Astral Step*](../vampire.md#astromancy-spatial-folding--teleportation)), weaving a sub-dimensional spatial anchor into a physical surface.
* **Pillar 2 (Dual-Layer Benefits & Synergy):**
  ...
  * **Power Synergy Bonus:** Casters who natively possess spatial powers ([*Astral Step*](../vampire.md#astromancy-spatial-folding--teleportation)) receive a **+2 Power Synergy Bonus** that extends the maximum recall range cap from 5 miles to **25 miles**.
...
### Grand Rite of Hematic Transmutation `(Tier 3 Primordial Rites — Hemomancy)`
* **Cost & Duration:** `3 Reserves | Duration: 24 Hours (then reverts to water)`
* **Pillar 1 (Power Amplification):** Amplifies alchemical blood powers ([*Gangrene Touch*](../vampire.md#biomancy-healing-biological-grafting--vital-control), [*Grand Harmonization*](../vampire.md#biomancy-healing-biological-grafting--vital-control)), projecting biological transmutation magic across macro environmental water reservoirs.
* **Pillar 2 (Dual-Layer Benefits & Synergy):**
  ...
  * **Power Synergy Bonus:** Casters who natively possess alchemical blood powers ([*Gangrene Touch*](../vampire.md#biomancy-healing-biological-grafting--vital-control) or [*Grand Harmonization*](../vampire.md#biomancy-healing-biological-grafting--vital-control)) receive a **+2 Power Synergy Bonus** to the 1-hour ritual completion check and a **+2 bonus to Concentration tests** if disturbed during casting.
* **Pillar 3 (Defined Caps & Boundaries):**
...
### Eclipse of the Sanguine Tide `(Tier 3 Primordial Rites — Hemomancy)`
* **Cost & Duration:** `3 Reserves | Duration: 1 Entire Night`
* **Pillar 1 (Power Amplification):** Amplifies environmental and mist powers ([*Mist Form*](../vampire.md#morphomancy-form-shifting--swarm-realms), [*Nightmare Visage*](../vampire.md#psychomancy-mind-illusion-telekinesis--influence)), elevating local mist into a macro 1-mile blood fog envelope.
* **Pillar 2 (Dual-Layer Benefits & Synergy):**
  ...
  * **Power Synergy Bonus:** Allied casters inside the fog zone who natively possess environmental or illusion powers ([*Mist Form*](../vampire.md#morphomancy-form-shifting--swarm-realms) or [*Nightmare Visage*](../vampire.md#psychomancy-mind-illusion-telekinesis--influence)) receive a **+2 Power Synergy Bonus** to power DCs and save DCs for powers cast inside the fog.
