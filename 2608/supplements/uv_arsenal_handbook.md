...
# Equipment & UV Arsenal Handbook v2608.48.0-bs
...
The **Equipment & UV Arsenal Handbook** is an official, opt-in supplement for the [Vampire TTRPG Framework](../vampire.md). It catalogs specialized tactical gear, hunter countermeasures, UV weaponry, thermal masking suits, and synthetic blood phials.

Following [Separation of Concerns](../vampire.md#system-agnostic--multi-genre-framework), this supplement expands upon the core [Banes & Countermeasures](../vampire.md#sunlight-disintegration-progression-the-3-round-burn) and [Armor Penetration Rules](../vampire.md#combat--elemental-evocation).

### Genre Translation Matrix

| Equipment Class | 🗡️ High Fantasy (*Mytharios*) | 🚀 Sci-Fi / Modern (*The Multiverse*) |
| :--- | :--- | :--- |
| **UV Weaponry** | Solar-enchanted mirrors, consecrated sun-crystal lanterns, dawn-lit arrows | Tactical UV laser rifles, military UV spotlight rigs, high-frequency solar frequency emitters |
| **Thermal Masking** | Salamander-skin cloaks, heated thermal talismans, warm alchemical wraps | Micro-wire thermal heat suits, bio-synthetic warmth pads, FLIR dampening cloaks |
| **Dietary Plasma** | Mana-infused blood phials, alchemical blood goblets, preserved sacrificial jars | Synthetic blood pouches (Synth-Vitae), bio-engineered plasma cartridges, cybernetic blood filters |

---

## Hunter Tactical Countermeasures

### High-Intensity UV Laser Rifles & Emitting Spotlights
...
## Vampiric Armaments & Field Gear

### Thermal Vitae Heating Gear & FLIR Suit
* **Gear Type:** `Body Armor Overlay / Undergarment`
* **Mechanic:** Micro-element heating wires generate artificial 37°C (98.6°F) body heat across the wearer's dermis, allowing a vampire to fool military FLIR thermal cameras and heat-seeking sensors even while using [Chameleon Facade](../vampire.md#alteration-forms--shifting).

### Obsidian Composite & Sanguine Weave Armor
* **Gear Type:** `Personal Body Armor | Rating: 2 Armor Points`
* **Mechanic:** High-density Kevlar and obsidian composite plates absorb mundane physical attacks (bullets, blades).
* **Bypass Scope:** Armor ratings apply strictly to mundane attacks. Supernatural armor-piercing powers like [Sanguine Spikes](../vampire.md#combat--elemental-evocation) or [Umbral Blades](../vampire.md#combat--elemental-evocation) ignore personal body armor.

### Synthetic Blood Pouches (Synth-Vitae) & Injectors
...
## Tactical Damage & Hardness Interaction Math

### Personal Body Armor vs Structural Integrity HP
* **Personal Armor:** Worn Kevlar or plate armor absorbs personal physical attack damage.
...
Vampires actively channeling [Daywalker's Grace](../vampire.md#immunities--resistances) are completely immune to artificial UV spotlights, UV lasers, and UV flashbangs without consuming their 3-minute natural solar shield timer.

---

## Integration & Compatibility

This supplement is 100% compatible with **Vampire TTRPG Framework v2608.48.0-bs**. All equipment rules interface cleanly with [Sunlight Burn Rules](../vampire.md#sunlight-disintegration-progression-the-3-round-burn), [Combat Evocation Armor Penetration](../vampire.md#combat--elemental-evocation), and [Blood Reserve Management](../vampire.md#blood-reserve-math--expenditure-caps).
