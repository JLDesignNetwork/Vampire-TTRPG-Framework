  ...
  "changelog": [
    ...
    },
    {
      ...
      },
      {
        ...
        "date": "2026-08-03",
        "summary": "Public Alpha release applying Round 10 Red Team Audit fixes: Combust Vitae Age Tier Scaling Table, Petrified Slumber Hibernation Scale (30-day min lock-in & early wake-up rituals), Centenary Compulsion command mediums, Weaver's Eclipse web counterplay, and Sanguine Spike/Umbral Blade structural damage math.",
        "added": [
          "Combust Vitae Age Tier Difference Scaling Table: Codified damage and flame effects based on age tier differences (Delta = Attacker Tier - Target Tier). Delta=+2: Total Incineration & instant Round 2 Flesh Ignition; Delta=+1: Severe Combustive Burst (+2 bonus damage); Delta=0: Standard Internal Flame; Delta=-1: Resisted Fizzle (0 wounds); Delta=-2: Complete Immunity (spell smothers completely).",
          "Petrified Slumber Hibernation Scale: Codified bare minimum 30-Day lock-in duration (with optional 1-Year or 100-Year Centenary Slumber tiers). Detailed early awakening rituals (3 drafts of vampire blood onto statue lips or >50 structural shock damage) and Native Soil maintenance requirements for vampires without Earthbreaker.",
      ...
      },
      {
        ...
        "date": "2026-08-03",
        "summary": "Public Alpha release applying Round 9 Red Team Audit fixes: Low-Reserve Shatter Degradation System, strict self-only Healing scope, Blood Archive phial zero-nutrition & crystallization, Kinetic Barrier evocation deflection, Primal Shift solar tissue combustion, and Grave Rot relic immunity.",
        "added": [
      ...
      {
        "version": "2608.15.0-as",
        "date": "2026-08-03",
        "summary": "Public Alpha release applying Round 8 Red Team Audit fixes: Digital Shroud FLIR scope, Echolocation vacuum dead zones, Slumbering Legion active minion caps, Sanguine Tithe draft quantities, Lethe's Touch Archive memory rules, and Spliced Reaper epidemic creation/lifespan mechanics.",
        "added": [
          "Spliced Reaper Epidemic & Lifespan Rules: Reaper contagion turns victims into Secondary Reapers or Secondary Husks (50/50 roll) with 0 creation cost and NO Sire-Fledgling bond. Imposed finite life expectancies due to synthetic DNA breakdown: 24 Hours for Secondary Husks, 7 Days (1 Week) for Secondary Reapers.",
          "Echolocation Vacuum & Silence Dead Zone: Specified that Echolocation Pulse requires a physical atmospheric medium and fails in hard vacuums or sound-dampened zones (The Cold Hush).",
          "Aura of the Slumbering Legion Minion Hard Cap: Active re-animated corpses hard-capped at ROUND(VAMPIRE_AGE / 100); recasting replaces older minions beyond the cap.",
          "Sanguine Tithe Quantities: Codified mandatory tithe requirement as 1 Blood Reserve per 5 harvested (or 1 draft per week) to the Apex Elder.",
          "Lethe's Touch vs. Archive Memory Rules: Drinking a Blood Archive draft grants third-person observation of historical events but does not remove Lethe's Touch memory blocks from a vampire's own mind."
        ],
        "modified": [
          "Updated Digital Shroud to clarify AI turret FLIR thermal and pressure plate sensor tracking.",
          "Overhauled Spliced Reaper combat and siring rules under Mutations."
        ],
        "fixed": [
          "Resolved infinite minion army exploits under Aura of the Slumbering Legion.",
          "Eliminated digital shroud thermal stealth ambiguities for AI turrets.",
          "Standardized tithe harvesting math across Covens."
        ]
      },
      {
        "version": "2608.14.0-as",
        "date": "2026-08-03",
        "summary": "Public Alpha release applying Round 7 Red Team Audit fixes: Age Tier Superiority Modifiers, Necrotic Vitae double-healing cost, Swarm Clearance Specs, Sire Compass Pocket-Realm blind spots, Master Power sub-power re-roll rules, and Spliced Reaper tongue grapple/infection math.",
        "added": [
          "Universal Age Tier Superiority Modifier System: Neonate (0), Elder (+1), Ancient (+2). Age difference grants mechanical bonuses/penalties in all Vampire vs Vampire opposed checks, fear rolls, commands, and physical struggles.",
          "Swarm Clearance Dimensional Specs: Declared exact structural opening clearances for all swarm forms (Rats: 2 in / 5cm, Bats: 3 in / 7.5cm, Spiders: 0.25 in / 6mm, Crimson Mist: vaporous keyhole/micro-vent).",
          "Master Power Sub-Power Re-Roll Rule: Formally codified that acquiring any Master Power forces automatic re-rolls for any pre-existing or duplicate minor sub-powers.",
          "Spliced Reaper Tongue Grapple & Infection Check: Added opposed Strength grapple math (targets >250kg pull Reaper) and a mandatory Constitution/Self-Control check to fight off viral vampiracy contagion on contact."
        ],
        "modified": [
          "Updated Necrotic Vitae to specify 2 Blood Reserves healing cost per gangrenous wound for rival vampires.",
          "Updated Sovereign Temperament & Visage of the Abyssal Nightmare to integrate Age Tier Superiority Modifiers.",
          "Updated Sire's Compass to detail Pocket-Realm tracking blind spots."
        ],
        "fixed": [
          "Eliminated healing suppression cost ambiguity for Necrotic Vitae.",
          "Resolved Swarm Form physical geometry exploits across rats, bats, spiders, and mist.",
          "Standardized opposed check modifiers for all inter-vampire interactions based on age tier."
        ]
      },
      {
        "version": "2608.13.0-as",
        "date": "2026-08-03",
        "summary": "Public Alpha release expanding the Sensory power pool with advanced multi-spectral sight, acoustic sonar, sub-auditory tremorsense, and Omni-Sensory Primacy.",
        "added": [
          "Thermal Vitae Vision: [Innate Toggle - 0 Reserves | Duration: Continuous Toggle]. Maps heat signatures and internal blood circulation in thermal FLIR gradients; highlights concealed weapons, body armor, organ trauma, and cold vampiric silhouettes.",
          "Electromagnetic Shroud Gaze: [Innate Toggle - 0 Reserves | Duration: Continuous Toggle]. Shifts vision into the EM spectrum to detect digital camera lenses, wiretaps, radio waves, and security lasers.",
          "Nyctophilous Apex Sight: [Innate Passive - 0 Reserves | Duration: Permanent]. Absolute pitch-black night vision immune to flashbang flares and optical disorientation.",
          "Echolocation Pulse: [Activated - 1 Reserve | Duration: 1 Scene]. Emits ultrasonic bio-sonar pulses to map enclosed building layouts, hidden rooms, and moving targets behind concrete walls up to 100ft.",
          "Sub-Auditory Tremor Echo: [Innate Passive - 0 Reserves | Duration: Permanent]. Detects micro-vibrations in floors and stone foundations up to 60ft, uncovering stealth ambushes and hidden passages.",
          "Cardiac Resonance: [Activated - 1 Reserve | Duration: 1 Scene]. Isolates and listens to mortal heartbeats, operating as a supernatural lie detector (+2 social interrogation bonus).",
          "Omni-Sensory Primacy (Master Power): [Innate Composite - 0 Reserves Activation]. The pinnacle of perception, combining Crimson Scent, Thermal Vitae Vision, Echolocation Pulse, and Sub-Auditory Tremor Echo in a single Master power slot."
        ],
        "modified": [
          "Expanded Sensory section under Behavioral Powers in vampire-2608.md."
        ],
        "fixed": [
          "Resolved sensory pool gap by establishing comprehensive visual, acoustic, vibrational, and thermal detection powers."
        ]
      },
      {
        "version": "2608.12.0-as",
        "date": "2026-08-03",
        "summary": "Public Alpha release introducing Innate Passive/Toggle/Composite power classifications, explicit activation durations across all powers, Master Power zero-cost initial activation, and the Aura of the Slumbering Legion necromancy power.",
        "added": [
          "Innate Power Sub-Types: Reclassified Constant to Innate, establishing Innate Passive (0 reserves, always on), Innate Toggle (0 reserves, turn on/off at will), and Innate Composite (Master Powers).",
          "Master Power 0-Cost Activation Rule: Master Powers grant 0-cost initial activation for all sub-powers; blood is expended strictly for sustained upkeep.",
          "Explicit Power Durations: Added clear duration bounds across all Activated and Sustained powers (Instantaneous 1-action, 1 Scene, 1 Round upkeep, 1 Hour Pocket-Realm, 1 Day Petrified Slumber).",
          "New Necromancy Power (Aura of the Slumbering Legion): [Activated / Sustained - 1 Reserve Activation (1 Scene) | Upkeep: 1 Reserve/Round]. Re-animates ROUND(VAMPIRE_AGE / 100) corpses within a [10 + ROUND(VAMPIRE_AGE/100)] ft diameter sphere. Optional upkeep maintains an active moving re-animation field."
        ],
        "modified": [
          "Updated Power Classification Framework to detail Innate Passive, Innate Toggle, Innate Composite, Activated (with durations), and Sustained (with upkeep).",
          "Reclassified and annotated all powers across Behavioral, Supernatural, and Necromancy sections in vampire-2608.md."
        ],
        "fixed": [
          "Resolved missing power duration ambiguities across all activated abilities.",
          "Eliminated reserve cost ambiguity for Master Power sub-ability invocations."
        ]
      },
      {
        "version": "2608.11.0-as",
        "date": "2026-08-03",
        "summary": "Public Alpha release introducing the Blood Reserves Aging Progression Growth Track and a comprehensive Power Classification Audit (Constant, Activated, Sustained).",
        "added": [
          "Blood Reserves Growth Track: All vampires begin with 10 reserves. Gaining +1 reserve every 250 years Post-Change and an additional +1 reserve every 500 years Post-Change (250yr = 11, 500yr = 13, 750yr = 14, 1000yr = 16, 1250yr = 17, 1500yr = 19, 1750yr = 20, 2000yr = 22).",
          "Post-2000 Year Reserves Scaling: After 2,000 years, vampires gain a flat +2 Blood Reserves every 250 years.",
          "Physiological Aging Rationale: Articulated how expanding heart capacity explains increased power output, higher siring capacity, larger Thrall networks, and multi-power maintenance as vampires age.",
          "Power Classification Framework: Categorized every power across Behavioral and Supernatural pools into Constant (0 reserves), Activated (1 reserve per invocation), or Sustained (1 reserve activation + 1 reserve/round).",
          "Comprehensive Power Audit: Formally annotated all 65+ powers with explicit mechanical activation type tags and reserve costs."
        ],
        "modified": [
          "Updated Blood Capacity & Passive Awakening Drain to detail the aging growth track.",
          "Updated Powers section to define Constant, Activated, and Sustained power categories.",
          "Annotated all Behavioral and Supernatural powers in vampire-2608.md with cost and type tags."
        ],
        "fixed": [
          "Eliminated reserve capacity disconnect between starting neonates and millennia-old ancients.",
          "Resolved ambiguous activation costs across all behavioral and supernatural powers."
        ]
      },
      {
        "version": "2608.10.0-as",
        "date": "2026-08-02",
        "summary": "Public Alpha release introducing Bloodline Memory scope limits, Phantasm mental targeting, Forensic Autopsy lab detection, Permanent Anchor Loss rules, Abyssal Levitation parameters, and Sanguine Shockwave Haven Sanctuary laws.",
        "added": [
          "Bloodline Memory Scope & Duration: Provides situational narrative context, language fluency, or ancient layout insights for 1 scene (+2 lore bonus); does NOT permanently grant combat skills or power proficiencies.",
          "Phantasm Mental Targeting Scope: Projects directly into the host mind, affecting all senses (visual, auditory, olfactory) of sentients; automated non-sentient physical machines and cameras are immune.",
          "Mask of Mortality & Sovereign Temperament Forensic Detection: Deep medical blood tests (toxicology, DNA sequencing) reveal room-temperature non-circulating blood lacking oxygen, exposing vampirism to medical labs.",
          "Pre-Change Anchor Replica Permanent Loss: Rebuilding a destroyed Sanctum or replacing a relic creates a physical replica, but does NOT restore the soul tether or remove the permanent -1 Self-Control penalty.",
          "Abyssal Levitation Speed & Altitude Caps: Levitation speed equals normal base movement speed; maximum altitude is capped at 1,000 feet above terrain (higher altitudes inflict turbulence and freezing penalties).",
          "Sanguine Shockwave Haven Sanctuary Violation: Hits ALL targets (allies and enemies) within 15 feet; invoking Sanguine Shockwave inside Haven grounds that hits or bleeds a fellow Coven member strictly violates the Law of Haven Sanctuary."
        ],
        "modified": [
          "Updated Bloodline Memory, Phantasm, Mask of Mortality, Pre-Change Anchors, Abyssal Levitation, and Sanguine Shockwave in vampire-2608.md."
        ],
        "fixed": [
          "Eliminated infinite skill and lore extraction exploit via Bloodline Memory.",
          "Clarified mental illusion vs non-sentient sensor mechanics for Phantasm.",
          "Prevented complete medical lab autopsy evasion using passive suppression powers.",
          "Eliminated replica reconstruction exploits for destroyed Pre-Change Anchors.",
          "Defined numerical movement speed and altitude ceilings for Abyssal Levitation.",
          "Resolved friendly fire and Haven Sanctuary law exploits for Sanguine Shockwave."
        ]
      },
      {
        "version": "2608.9.0-as",
        "date": "2026-08-02",
        "summary": "Public Alpha release introducing Pocket-Realm Solar Transference, Sovereign Temperament Shatter bonuses, Structural Hardness distinctions, Corpse Siphon Skull Contact, Daywalker Recovery Resets, and Blood Archive Mortal Poisoning.",
        "added": [
          "Pocket-Realm Solar Transference & Maintenance: Solar radiation on a manifested swarm transfers 100% into the body inside the Pocket-Realm; sustaining a Pocket-Realm consumes 1 Blood Reserve per hour.",
          "Sovereign Temperament Shatter Bonus: Sovereign Temperament grants a +2 mechanical bonus to the Shatter Attempt check, but does NOT grant automatic success or bypass trauma costs.",
          "Structural Hardness vs Personal Armor Ratings: Armor Penetration applies strictly to personal body armor worn by combatants; heavy structural barriers (vault doors, tank hulls) possess Structural Integrity HP and are not bypassed.",
          "Corpse Siphon Skull Contact: Corpse Siphon requires direct physical hand contact upon the skull/brain of the deceased host to extract residual neural memories.",
          "Daywalker Recovery Window Strict Reset: Any solar exposure before completing the 6-hour shadow / 1-night Native Soil recovery window immediately resets the recovery timer back to 0.",
          "Blood Archive Mortal Ingestion Profile: Only vampires can process psychic memories in Blood Archive vials; mortals who drink archive drafts gain no memories and suffer severe vitae poisoning or instant enthrallment."
        ],
        "modified": [
          "Updated Pocket-Realm Shift Mechanism, Sovereign Temperament, Centenary Compulsion, Sanguine Spike, Umbral Blade, Corpse Siphon, Daywalker's Grace, and Blood Archives in vampire-2608.md."
        ],
        "fixed": [
          "Eliminated daytime solar stasis exploit via Pocket-Realm swarm hiding.",
          "Resolved passive command immunity exploit with Sovereign Temperament.",
          "Eliminated instant structural vault slicing exploit with Evocation strikes.",
          "Resolved headless body memory extraction loophole.",
          "Prevented partial solar exposure recovery exploitation for Daywalker's Grace.",
          "Prevented unsanctioned mortal memory siphoning from Coven Blood Archives."
        ]
      },
      {
        "version": "2608.8.0-as",
        "date": "2026-08-02",
        "summary": "Public Alpha release introducing Final Drop Petrification, Tier 3 Adrenaline Burnout, Chronicler Telepathic Network, Blood Archive Rituals, Pyromancy Oxygen Immunity, Swarm Pocket-Realms, and Sanguine Knit Control Signal limits.",
        "added": [
          "Final Drop Revision: Consuming the final drop of a mortal causes immediate True Death beside the victim; consuming the final drop of an immortal/vampire (Diablerie) triggers a blood feedback shockwave that petrifies the vampire into Eternal Petrified Torpor.",
          "Tier 3 Hero Blood Side-Effect (Adrenaline Burnout): Non-stacking physical action bonus (+1 max for 1 hour); once expired, neural burnout inflicts a temporary -1 physical action penalty for 1 hour.",
          "The Chronicler's Connection (Shared Telepathic Network): All Coven Scribes share a synchronized telepathic memory network; memory wipes on a single Chronicler are automatically backed up by others.",
          "Blood Archive Rituals: Preserved drafts of blood stored in obsidian vials act as physical chronological archives; drinking a draft allows a vampire to 'read' that era in first-person sensory detail like a book.",
          "Pyromancy Oxygen Immunity: Blood Pyromancy is fueled by pressurized vitae rather than atmospheric oxygen, burning continuously in zero-oxygen vacuums, underwater, and in airlocks.",
          "Swarm Form Personal Pocket-Realms: Shifting into a Swarm Form teleports the physical body and gear into a safe-haven Pocket-Realm dimension while manifesting the swarm in reality; total swarm destruction forcibly ejects the vampire into reality at Stage 4 Torpor.",
          "Sanguine Knit Control Signal Requirement: Sanguine Knit is fueled by blood in the heart but controlled by brain signals from the head; severing the head breaks the control tether, preventing active blood healing."
        ],
        "modified": [
          "Updated Draining, Blood Quality Tiers, Ancient Diablerie, Swarm Powers, Pyromancy, Decapitation, and Coven Sacred Laws in vampire-2608.md."
        ],
        "fixed": [
          "Eliminated character sheet overwrite ambiguity for Ancient Diablerie.",
          "Eliminated unlimited Tier 3 Hero Blood buff stacking and added neural burnout side-effects.",
          "Eliminated single-target memory wipe vulnerability for Coven lore.",
          "Clarified zero-oxygen Pyromancy functionality in multi-genre Sci-Fi/Space environments.",
          "Resolved inventory mass math and physical body safety during Swarm Form transformations.",
          "Eliminated decapitated headless stump blood healing exploits."
        ]
      },
      {
        "version": "2608.7.0-as",
        "date": "2026-08-02",
        "summary": "Public Alpha release introducing Decapitation Brain Torpor, Master Primacy Re-Roll rules, Daywalker Recovery Windows, Thrall Dual-Master Rejection, Native Soil Slumber Contact rules, and Reaper Secondary Husk Decay.",
        "added": [
          "Decapitation Brain Torpor: Severed head holds 0 blood reserves; lapses into Brain Torpor within 24 hours without blood flow or re-attachment.",
          "Random Power Generation & Master Primacy Re-Rolls: Powers are randomly generated from bloodline latency. Generating a Master Power grants master primacy, automatically re-rolling any minor sub-powers owned or generated afterwards.",
          "Feral State Drinking vs Draining: Clarified that starving vampires in a Feral State instinctually drink (restrained feeding). Choosing to drain while starving forces a Hard Self-Control check to avoid consuming the final drop.",
          "Daylight Dying Echo Feedback Suppression: A vampire awakened by a daylight Dying Echo who perishes does NOT trigger a secondary Daylight Interruption shockwave within the same 12-hour window.",
          "Daywalker's Grace Exposure & Recovery Window: Grants up to 3 minutes of direct solar exposure (-2 penalty/steam burns). Requires a Recovery Window of 1 full night of Native Soil slumber (or 6 hours total shadow) before reuse.",
          "Evocation & Shadow Blade Armor Penetration: Sanguine Spike and Umbral Blade ignore mundane physical armor ratings (Kevlar, steel plate); targets may still attempt Dodge checks or project energy barriers (Kinetic Barrier).",
          "Thrall Stacking & Dual-Master Conflict: Consuming multiple drafts of vitae in 1 sitting is capped at 14 days max duration; ingesting blood from a 2nd vampire triggers violent neurological shock, causing the Thrall to vomit both bloods.",
          "Native Soil Slumber Contact Requirement: 3kg portable Native Soil only satisfies the supernatural tether during stationary, undisturbed daytime slumber.",
          "Secondary Reaper Husk 24-Hour Lifespan: Secondary Feral Husks created via Reaper Contagion lack a Sire soul tether; synthetic viral overload melts secondary Husks into black sludge after 24 hours.",
          "Knockback Distance & Evasion Math: Kinetic Blast and Sanguine Shockwave hurl targets backward up to 20 feet and knock them prone; targets near ledges may make an Agility/Evasion check to catch a ledge.",
          "Digital Shroud Sensor Scope: Digital Shroud distorts optical video/facial recognition sensors (pixelated blur), but non-optical sensors (infrared thermal, acoustic, pressure, laser tripwires) operate normally.",
          "Rousing Frenzy Target Priority: Rescuer frenzy prioritizes living mortal blood first, followed by blood bags, and finally the rescuer's undead throat if no mortal blood is present."
        ],
        "modified": [
          "Updated Decapitation, Dying Echo, Feral State, Power Fade, Daywalker's Grace, Sanguine Spike, Umbral Blade, Thralls, Native Soil, and Mutations in vampire-2608.md."
        ],
        "fixed": [
          "Eliminated infinite headless stasis loophole.",
          "Eliminated duplicate power slot inflation with Master Powers.",
          "Resolved ambiguity between frenzied drinking vs draining during creation/starvation.",
          "Eliminated cascading city-wide Dying Echo feedback loops.",
          "Resolved core solar immunity duration ambiguity for Daywalker's Grace.",
          "Eliminated physical armor invalidation math for Evocation strikes.",
          "Eliminated infinite Thrall vitae duration stacking and multi-master stealing exploits.",
          "Eliminated shoe/clothing portable Native Soil exploits.",
          "Prevented permanent, un-decaying Reaper secondary husk swarm overruns."
        ]
      },
      {
        "version": "2608.6.0-as",
        "date": "2026-08-02",
        "summary": "Public Alpha release introducing Categorized Blood Reserve Spending Caps, Over-Push Strain, The Primordial Resonance, Ancestral Inheritance Scaling, Mental Torpor Drift, and Active Power Maintenance Costs.",
        "added": [
          "Categorized Per-Round Expenditure Caps: 1 Blood Surge max/round (+2 physical stat), 1 Maintenance max/round, 1 Healing max/round (total max 2 reserves spent per combat round across all actions).",
          "Over-Push Strain: Attempting to spend blood reserves at 0 reserves inflicts 1 Direct Core Health Damage or triggers an immediate Self-Control frenzy check.",
          "The Primordial Resonance (Unified Ancient Web): All 1,200+ year Ancients are tethered through a collective bloodline web, enforcing the Anti-Battery Farm Rule (1 permanent power slot per century IN TOTAL across all Ancients).",
          "Primordial Resonance Perks: Ancients gain planetary Primordial Telepathy; Ancient death ripples through the web, empowering all neonates holding Ancient Vitae for 1 night (+1 all power rolls).",
          "Ancestral Inheritance Scaling: Siring by Elders (500+ yrs) grants +1 bonus starting Behavioral slot; siring by Ancients (1,200+ yrs) grants +1 bonus starting Supernatural AND +1 bonus Behavioral slot.",
          "Mental Torpor Drift: Phase 1 Torpor sensory awakening naturally drifts back into unconscious Torpor after 24 hours without blood, preventing endless torture loops.",
          "Multiplicative Soil Decay: Multiple Thralls digging up Native Soil on Day 14 stack decay multiplicatively (1st Thrall = 6 days; each additional Thrall = -50% remaining soil life).",
          "Active Power Maintenance Cost: Continuous defense or illusion powers (Kinetic Barrier, Psychic Fortress, Pyre Aura, Puppet Master) require 1 Blood Reserve per power per combat round to sustain."
        ],
        "modified": [
          "Updated Blood Capacity & Passive Awakening Drain to include categorized per-round spending caps and Over-Push Strain rules.",
          "Updated The Effects of Drinking Ancient Blood to detail The Primordial Resonance and the century cap across all Ancients.",
          "Updated Power Fade & Inheritance to include Ancestral Inheritance Scaling based on Sire age tier.",
          "Updated Torpor Phase 1 Awakening to include the 24-hour Mental Torpor Drift safety valve.",
          "Updated Thrall Inaccessible Master soil extraction rules to include multiplicative decay for multiple Thralls."
        ],
        "fixed": [
          "Eliminated unlimited Blood Surge combat stacking exploit.",
          "Eliminated Coven Ancient Vitae battery farming exploit.",
          "Fixed mathematical irrelevance of Power Fade cap for ancient sires siring starting characters.",
          "Eliminated endless Torpor Phase 1 sensory paralysis torture loop.",
          "Resolved ambiguity regarding multiple Thralls digging up Native Soil grave sites simultaneously.",
          "Eliminated static invulnerability stacking of Kinetic Barrier + Psychic Fortress."
        ]
      },
      {
        "version": "2608.5.0-as",
        "date": "2026-08-02",
        "summary": "Public Alpha release introducing 3-Tier Age Hierarchy, Ancient Vitae mechanics, Anti-Mass Siring rules, blood economy reconciliation, and comprehensive behavioral overhaul.",
        "added": [
          "Formalized 3-Tier Age Hierarchy: Neonates (<500 yrs), Elders (500–1,199 yrs), and Ancients (1,200+ yrs) with distinct starting NPC pools, physical species perks, and societal roles.",
          "Tier 5 Ancient Vitae (1,200+ years) granting 4 Blood Reserves per draft, High-Power Surge, 24-hr memory siphon, plus Permanent Power Gain (1 slot per draft, once per century) and Soul Strain Risk (Hard Self-Control check).",
          "Full Diablerie rules for Ancients (2 chosen permanent power slots, Near-Impossible Soul Possession Risk).",
          "Creation Limitations & Anti-Mass Siring rules: 5 Blood Reserves creation cost, 30-Day Bloodline Cooldown (Sanguine Exhaustion), 3-Year Psychic Rebound (emotional static bleed & Psychic Overload Hazard), and Progeny Capacity Caps based on age tier.",
          "Overhauled Behavior & Physiology section: Default Biological Traits (retractable fangs, cold dermis, statue stillness, eye glint), Predatory Aura (30ft animal panic, Uncanny Valley +1 social penalty, 1–2 hr post-feeding camouflage), Cardiac Hyper-Focus (+1 tracking bonus), Territorial Boundaries (-1 stealth in rival territory), and Nocturnal Detachment (The Daylight Rift).",
          "Reconciled Blood Economy: Passive sunset awakening drain (1 reserve/night) and 0-reserve Starvation timer initiation.",
          "Defined baseline physical wound healing cost (1 reserve/injury) and Holy Water double-reserve healing cost (2 reserves/wound in Native Soil).",
          "Defined Heavy Cloud Cover 0-reserve collapse rule: thermal insulation fails at 0 reserves, igniting flesh into Round 2 combustion.",
          "Reconciled Dying Echo vs Decapitation Telepathy: passive Dying Echo remains vague (vector/distance), while active 6-second telepathic invocation from a severed head allows exact landmark/word broadcast.",
          "Defined non-mortal Anchor Break Check destruction mechanics for Sanctums (demolition), Relics (shattering), and Oaths (atrocities).",
          "Explicitly exempted Spliced Reaper viral bites from 30-Day Cooldowns, Reserve costs, and Progeny Caps for exponential swarm creation."
        ],
        "modified": [
          "Updated Blood Capacity & Storage to include passive awakening drain and 0-reserve Starvation timer trigger.",
          "Updated Types section to structure Neonates, Elders, and Ancients into 3 distinct formal age categories.",
          "Updated Anchor Break Check failure rules to handle all 3 Anchor categories (Mortal, Sanctum, Ideal/Relic)."
        ],
        "fixed": [
          "Resolved contradiction between passive Dying Echo GPS coordinates and Decapitation telepathy warning.",
          "Resolved undefined baseline cost for Holy Water double blood reserve regeneration."
        ]
      },
      {
        "version": "2608.4.0-as",
        "date": "2026-08-02",
        "summary": "Public Alpha release introducing System-Agnostic Multi-Genre Framework, Necromancy & Grave Arts, Blood Pyromancy, Telekinesis, expanded Swarm Primacies, and major mechanical audit fixes.",
        "added": [
          "System Agnostic & Multi-Genre Framework mapping core mechanics between High Fantasy (Mytharios) and Sci-Fi/Modern (The Multiverse).",
          "Necromancy & Grave Arts power suite (Corpse Siphon, Rise of the Slumbering, Grave Rot, Soul Bind, and Necromantic Primacy Master Power).",
          "Blood Pyromancy & Combat Evocation power suite (Hellfire Orb, Combust Vitae, Pyre Aura, Pyromantic Primacy, Sanguine Spike, Umbral Blade, Grave Chill, Kinetic Blast, Nerve Lightning).",
          "Telekinesis & Advanced Mental power suites (Mind Grip, Kinetic Barrier, Kinetic Crush, Telekinetic Primacy, Phantasm, Puppet Master, Psychic Fortress).",
          "Species-specific Swarm Primacies: Bat Swarms (Vesper Canopy, Blood-Siphon Gale, Bat Primacy) and Rat Swarms (Trench Plague, Gnawing Scourge, Verminous Primacy), joining Spider Swarms (Weaver's Eclipse, Arachnid Tide, Silk & Shadow, Arachnid Primacy).",
          "Surgical / Medical Sewing method for limb re-attachment (12 hours physical recovery).",
          "System-agnostic mechanical difficulty definitions for the Hard Self-Control check during Anchor Break checks."
        ],
        "modified": [
          "Restructured Torpor Awakening into a Two-Phase process (single drop for sensory consciousness; 250ml draft for physical rousing with an immediate Rousing Frenzy Check).",
          "Updated Old World transition rules: 500-year mark unlocks Old World species perks (+2 Initiative, 2x movement, free positioning action) while retaining linear power scaling (+1 power per 150 years); initial Old World stat block reserved exclusively for ancient character generation.",
          "Updated Vitreous Blood (Unholy Primacy Master Power) to provide complete combined immunity to holy water, garlic, and crucifixes while explicitly removing wooden stake immunity.",
          "Clarified Thrall Capacity milestones: early Shatter Attempts break sire compulsion but do not grant early Thrall capacity slots (first slot unlocks strictly at Year 100).",
          "Locked Re-Rooting Interruption Penalty (+1 day / 24 hours) as static and completely immune to Thrall Blood Sacrifice acceleration."
        ],
        "fixed": [
          "Scrubbed all generic filler power names across the document, replacing them with atmospheric titles (e.g., Siren's Cadence, The Cold Hush, Blood Harmonic, Sovereign Temperament, Sanguine Knit).",
          "Resolved mathematical ambiguity in Power Fade Collapse, adding a narrative warning regarding the hubris of young sires attempting creation with fewer than 4 total powers."
        ],
        "removed": [
          "Removed generic power names (Golden Tongue, Emotion Block, Emotion Sway, Mind Probe, Mist Form, Swarm Form, Beast Shape, Statue Form, Holy Skin, Iron Stomach).",
          "Removed wooden stake immunity from Vitreous Blood."
        ]
      }
    ],
    "todo": [
      {
        "id": "TODO-01",
        "section": "## Creation",
        "title": "Overhaul Creation Section with Visceral Metaphysics & Dual-Genre Rituals",
        "status": "completed",
        "details": "Expand the bare 5-line Creation section into a comprehensive guide detailing the Three Phases of Turning (Death Threshold, Sanguine Transfusion, First Awakening), physiological transformation cues, and dual-genre ritual variations (High Fantasy blood chalices vs Sci-Fi bio-transfusions)."
      },
      {
        "id": "TODO-02",
        "section": "## Death -> ### Sunlight Lethality Baseline",
        "title": "Implement 3-Stage Solar Disintegration Track & Light Intensity Rules",
        "status": "completed",
        "details": "Replace informal Twilight text with a structured 3-stage solar burn track (Dermal Vaporization -> Flesh Ignition -> Ash Collapse), environmental filtering rules (direct sun vs heavy cloud cover vs UV glass), and shade survival mechanics."
      },
      {
        "id": "TODO-03",
        "section": "## Death -> ### Banes & Weaknesses",
        "title": "Expand Sensory Flavor & System-Agnostic Debuffs for All Banes",
        "status": "completed",
        "details": "Deepen Holy Water, Garlic, Crucifixes, and Stakes with visceral sensory descriptions, environmental aura radii (e.g. 10ft sacred repulsion aura), tracking debuffs, organ spasms, and stake motor immobilization rules."
      },
      {
        "id": "TODO-04",
        "section": "## Social -> Covens",
        "title": "Flesh Out Coven Hierarchy, Sacred Laws, and Haven Governance",
        "status": "completed",
        "details": "Expand the 2-line Coven section to define formal titles (The Apex Elder, The Regent Enforcer, The Keeper, The Fledgling), Haven Laws (The Silence, Haven Sanctuary, Blood Tithes), and territorial war rules."
      },
      {
        "id": "TODO-05",
        "section": "## Types -> #### Mutations",
        "title": "Define Complete Profiles & Stat Mechanics for Mutant Strains",
        "status": "completed",
        "details": "Provide full sensory profiles, behavioral traits, and combat stat adjustments for the three mutation types: The Feral Husk (botched drain ghoul), The Hollow Abomination (power-fade collapse mutant), and The Spliced Reaper (artificial/cyber-gene mutant)."
      },
      {
        "id": "TODO-06",
        "section": "## Behavior",
        "title": "Expand Vampiric Psychology, Predatory Aura & Territory",
        "status": "completed",
        "details": "Expand the short Behavior overview to detail predatory aura effects on animals/mortals, night-stalking hunting psychology, territorial marking, and emotional detachment from daylight humanity."
      },
      {
        "id": "TODO-07",
        "section": "## Life -> #### Pre-Change & Post-Change",
        "title": "Detail Humanity Anchor Mechanics & Humanity Loss Scale",
        "status": "completed",
        "details": "Expand Pre-Change Anchors with selection rules, damage/restoration mechanics, and Anchor categories (Loved Ones, Sacred Oaths, Relics). Detail the Post-Change Humanity vs Hunger scale and frenzy triggers."
      },
      {
        "id": "TODO-08",
        "section": "## Mechanics -> Drinking & Sustenance",
        "title": "Flesh Out Blood Quality Tiers, Storage, and Blood Surges",
        "status": "completed",
        "details": "Expand drinking mechanics with blood quality tiers (Animal Blood, Mundane Mortal, High-Vibrancy/Hero Blood, Elder Vitae), blood storage limits, and temporary physical Blood Surges."
      },
      {
        "id": "TODO-09",
        "section": "## System Agnostic & Multi-Genre Framework",
        "title": "Expand Multi-Genre Matrix for Diet, Haunts & Tech",
        "status": "completed",
        "details": "Enrich the Multi-Genre matrix to include Dietary Substitutes (synth-blood vs mana-infused blood), Haunts/Havens (orbital stations vs gothic catacombs), and Communication/Sensory tech."
      },
      {
        "id": "TODO-10",
        "section": "## Types -> New World & Old World",
...
**Thought**
* **The Collective Whisper `[Activated - 1 Reserve | Duration: 1 Scene]`:** You project a telepathic wave across a crowd that whispers simultaneously into dozens of mortal minds. The crowd reacts as a single organism—collectively dispersing, bursting into unexplained protest, or looking away from a bloody supernatural event as if nothing happened.
...
* **Sanguine Spike `[Activated - 1 Reserve | Duration: Instantaneous (1 Attack)]`:** You solidify a stream of pressurized vitae into razor-sharp, obsidian-hard blood javelins. You hurl these spikes with supernatural force, piercing heavy body armor and pinning targets to stone walls. *Armor Penetration:* Ignores mundane physical armor ratings (Kevlar, steel plate); targets may still attempt Dodge checks or project supernatural energy defenses (*Kinetic Barrier*). *Structural Hardness Math:* Applies strictly to personal body armor worn by combatants. Heavy structural barriers (armored vault doors, tank hulls, reinforced concrete) possess Structural Integrity Hit Points and are not instantly bypassed; Sanguine Spikes deal standard physical damage against the barrier's Structural HP pool.
...
* **Blood Resonance & Synergies:** When vampires of the same bloodline come into close proximity, they instinctively taste and feel the resonance of their shared ancestry.
  * **Lineage Harmonization (Bonus):** Mental and emotional behavioral powers (such as *Siren’s Cadence*, *Imperious Word*, and *Mind Tear*, see [Behavioral Powers](#behavioral-powers)) are significantly more potent when targeting vampires of your own direct bloodline (sires, fledglings, or blood-siblings). The shared blood frequencies make their minds far easier to influence (+2 mechanical success bonus). *Modifier Stacking:* Lineage Harmonization (+2 bonus against direct bloodline) explicitly **STACKS** with [Universal Age Tier Superiority](#mechanics) modifiers (+1 or +2), reflecting how ancient sires possess near-absolute mental dominance over their direct progeny.
...
* **Covens & Governance:** Sires hold absolute authority over their fledglings. Vampires rarely survive long alone, forming Covens for territorial control, collective defense, and bloodline preservation.
  ...
  * **The Four Sacred Laws of the Coven:**
    ...
    4. **The Law of the Tabula Rasa (Unwritten Memory):** It is strictly forbidden to write, draw, paint, photograph, or digitally record any image, name, physical description, or record of another vampire—or of oneself. All lineage history, names, and lore must be preserved purely through oral tradition or telepathic memory ([*Bloodline Memory*](#behavioral-powers)). Creating physical or digital records of a vampire is high treason, punished by immediate destruction of the records and severe physical discipline.
      ...
      * **The Blood Archive Ritual (Physical Blood Vaults):** To maintain chronological physical backups without violating Tabula Rasa, Chroniclers conduct a periodic blood storage ritual: preserving micro-drafts of blood in small, sealed obsidian phials labeled chronologically (*Blood Archives*). Drinking a draft from a Blood Archive phial allows a vampire to "read" that era's recorded events in vivid, first-person sensory detail—just like reading a physical history book!
...
* **Thralls & Vitae Addiction:** Mortals who are fed upon and given small drafts of vampire blood (vitae) become deeply bound to their vampire master.
  ...
  * **Dual-Master Conflict:** A Thrall who ingests vitae from a second vampire suffers violent neurological shock (bloodline rejection), causing them to vomit both bloods and fail the enthrallment attempt.
...
* **Combat Adjustments:**
  ...
  * **Reaper Contagion & Contact Check:** Bypasses traditional draining/feeding rituals entirely. A bite, claw laceration, or barbed tongue grapple from a Spliced Reaper injects a synthetic viral mutagen. Any target hit must immediately pass a **Hard Constitution / Self-Control check** to fight off the contagion:
    * *Mortal Failure (Epidemic Transformation):* The synthetic virus mutates living tissue within 60 seconds, transforming the mortal into either a **Secondary Spliced Reaper (50% chance)** or a **Secondary Feral Husk (50% chance)**.
    * *Vampire Failure:* Vampires are immune to full mutation but suffer severe internal tissue decay, taking **1 Direct Core Health Damage** and suffering a **-1 penalty to physical actions** for 1 scene.
  ...
  * **Synthetic DNA Cellular Breakdown (Finite Lifespans):** Because viral Reapers and Husks lack a true heart reservoir tether or ancient bloodline magic, their hyper-engineered synthetic DNA inevitably suffers catastrophic cellular breakdown:
