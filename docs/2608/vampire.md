...
* **Natural Transition at Year 1,200 (The Primordial Rite):** When an Elder survives to their 1,200th anniversary post-change, they achieve **Ancient Status**:
  1. **Primordial Species Perk Upgrade:** Their physical form becomes near-godlike (+3 Initiative bonus, 3x base movement speed, doubled jump distance, 2 free Round 1 positioning actions, and complete immunity to non-magical physical weapon damage). *Anatomical Bane Exception:* General weapon immunity shrugs off ambient trauma and superficial strikes, but does NOT grant immunity to targeted anatomical banes executed under their specific mechanics: a targeted wooden stake driven directly into the heart ([Cardiac Piercing](#stake-through-the-heart)) still paralyzes the Ancient into Torpor, and decapitation ([Decapitation](#decapitation)) severs power transmission and paralyzes the body, allowing enemies to expose the immobilized heart or expose the Ancient to sunlight for True Death.
  2. **Continued Power Growth:** Total power slot count continues scaling naturally (+1 power per 150 years lived).
