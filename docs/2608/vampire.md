...
* <a id="necromantic-primacy"></a>**Necromantic Primacy (Master Power) `[Supernatural - Master | Innate Composite - 0 Reserves Activation]`:** The pinnacle of death manipulation. You possess [*Corpse Siphon*](#corpse-siphon), [*Rise of the Slumbering*](#rise-of-the-slumbering), [*Aura of the Slumbering Legion*](#aura-of-the-slumbering-legion), [*Grave Rot*](#grave-rot), and [*Soul Bind*](#soul-bind), granting absolute control over post-mortem interrogation, individual and mass corpse animation, decay, and spirit binding in a single Master power slot.
...
*Powers that command thermal extremes—igniting oxygen-free hellfire fueled by pressurized vitae, combusting enemy blood from within, and projecting flash-freeze waves of tomb chill.*
* <a id="pyromancy-vacuum-immunity"></a>**Supernatural Fuel Source (Pyromancy Vacuum Immunity):** Blood Pyromancy ([*Hellfire Orb*](#hellfire-orb), [*Pyre Aura*](#pyre-aura), [*Thermal Ignition*](#thermal-ignition)) consumes pressurized vampiric vitae as fuel rather than atmospheric oxygen. Hellfire Orbs and Pyre Auras burn continuously in zero-oxygen vacuums (orbital space stations, airlocks), underwater, and in toxic gas clouds without extinguishing!
...
* <a id="psychokinetic-primacy"></a>**Psychokinetic Primacy (Master Power) `[Supernatural - Master | Innate Composite - 0 Reserves Activation]`:** The pinnacle of psychokinesis. You possess [*Psychic Grip*](#psychic-grip), [*Gravity Shield*](#gravity-shield), and [*Grav-Crush*](#grav-crush), granting absolute mastery over telekinetic lifting, projectile defense, and force crushing in a single Master power slot.
...
*Powers that alter physical biology and dimensional presence—dispersing into pocket-realm animal swarms, reshaping flesh into apex beasts, drifting as gaseous mist, or petrifying into granite slumber.*
...
* <a id="bat-primacy"></a>**Bat Primacy (Master Power) `[Supernatural - Master | Innate Composite - 0 Reserves Activation]`:** The pinnacle of nocturnal flight. You possess both [*Bat Swarm*](#bat-swarm) (`Sustained`) and [*Siphon Gale*](#siphon-gale) (`Activated`), granting complete mastery over bat swarm flight, echolocation mapping, and aerial blood siphoning in a single Master power slot.
...
* <a id="verminous-primacy"></a>**Verminous Primacy (Master Power) `[Supernatural - Master | Innate Composite - 0 Reserves Activation]`:** The pinnacle of subterranean infestation. You possess both [*Rat Tide*](#rat-tide) (`Sustained`) and [*Gnawing Scourge*](#gnawing-scourge) (`Activated`), giving you complete control over rat swarm stealth infiltration, pipe navigation, and equipment sabotage in a single Master power slot.
...
* <a id="arachnid-primacy"></a>**Arachnid Primacy (Master Power) `[Supernatural - Master | Innate Composite - 0 Reserves Activation]`:** The pinnacle of spider-swarm mastery. You possess [*Weaver Swarm*](#weaver-swarm), [*Arachnid Shift*](#arachnid-shift), and [*Silk & Shadow*](#silk-and-shadow). Whenever you shift into a spider swarm, you choose which specific manifestation or tactical effect to invoke—or combine their traits into a singular, terrifying arachnid storm.
