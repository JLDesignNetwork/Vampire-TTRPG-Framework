...
1. **`Innate` (Passive / Toggleable / Composite - 0 Reserves):**
   * **Mechanism:** Woven into the vampire's physiology, bloodlin    * **Sub-Types:**
      ...
      * **`Innate Composite` `[Master Powers - 0 Reserves Activation]`:** Holding a Master Power slot represents apex mastery over a specific discipline.
        * **The Universal 3-Power Selection Rule:** Upon acquiring a Master Power slot (at creation or advancement), the vampire selects **any 3 powers** from that discipline's available power pool.
        * **0-Cost Initial Activation Advantage:** The 3 selected powers cost **0 Blood Reserves to activate** (free initial invocation), burning blood strictly for subsequent sustained upkeep or per-round maintenance.
...
* <a id="psychokinetic-primacy"></a>**Psychokinetic Primacy (Master Power) `[Supernatural - Master | Innate Composite - 0 Reserves Activation]`:** The pinnacle of psychokinesis. Under the **Universal 3-Power Selection Rule**, you select **any 3 powers** from the Psychomancy pool (*Psychic Grip*, *Gravity Shield*, *Grav-Crush*, *Kinetic Blast*), gaining 0-Reserve initial activation for all three selected powers.
